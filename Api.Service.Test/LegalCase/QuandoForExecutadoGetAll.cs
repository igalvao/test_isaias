...
{
    public class QuandoForExecutadoGetAll : LegalCaseTestes
    {
        ...
        public async Task E_Possivel_Executar_Metodo_GetAll()
        {
            ...
            _serviceMock.Setup(m => m.GetAll()).ReturnsAsync(listaLegalCaseDto);
            ...
            var _listResult = new List<LegalCaseDto>();
            _serviceMock = new Mock<ILegalCaseService>();
